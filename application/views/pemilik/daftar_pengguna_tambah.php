                ...
                <div class="card-body">
                    ...
                    <?php echo form_open_multipart('AuthController/registrasi');?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p>Email
                                    <input type="email" name="email" class="form-control" placeholder="Masukkan Nama Lengkap Anda">
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p>Password
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p>No. Handphone
                                    <input type="text" name="no_hp" class="form-control" placeholder="Masukkan Nama Lengkap Anda" required>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <p>Level
