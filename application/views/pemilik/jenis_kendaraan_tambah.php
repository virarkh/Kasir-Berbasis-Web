                ...
                <div class="card-body">
                    <form action="<?php echo base_url(). 'JenisKendaraanController/tambah_data'?>" method="POST">
                        <div class="form-group">
                            <p>Jenis Kendaraan
                                <input type="text" name="nama_kendaraan" placeholder="Masukkan Jenis Kendaraan Baru" class="form-control" style="margin-top: 5px;" required>
                            </p>
                        </div> 
                        <div class="form-group">
                            <p>Tarif
                                <input type="number" name="tarif" placeholder="Masukkan Tarif Baru" class="form-control" style="margin-top: 5px;" required>
                            </p>
                        </div>
